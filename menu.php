...
<!-- this is for fixed on top after scroll for cart mobile ends -->
<!-- this is for category for stick to top -->
<script type="text/javascript">
$(function(){
        ...
        $(window).scroll(function(){
                if( $(window).scrollTop() > stickyRibbon ) {
                        $('#sticky').css({position: 'fixed', top: '0px',width:'95%'});
                } else {
...
<!-- mobile stick to top starts -->

<script type="text/javascript">
$(function(){
        var sRibbon = $('#stickyy').offset().top;
          
        $(window).scroll(function(){
                if( $(window).scrollTop() > sRibbon ) {
                        $('#stickyy').css({position: 'fixed', top: '28px',width:'95%'});
                } else {
                        $('#stickyy').css({position: 'static', top: '0px'});
                }
        });
});
</script>
...
<!-- this is for category on desktop view starts -->

<!-- this is for category on desktop view ends -->
<!-- ends here -->
...
<div id="stickyribbon_mv"><div id="showmenu">Khana Kart<i style="float: right; padding-right: 35px;" class="fa fa-shopping-cart"></i></div>
...
<center>
  ...
  <i class="fa fa-shopping-cart"></i>&nbsp;Food Cart</div></center>
...
<div class="cart_element"><i class="fa fa-clock-o"></i></i>&nbsp;&nbsp;Minimum Order:&nbsp;&nbsp;&nbsp;&nbsp;RS &nbsp;200</div></div>  
</div>
</div>
</div>
...
<div class="container">
  ...
  $menu_name_type="SELECT DISTINCT name,serv_fee,vat,serv_tax,container_fee  FROM `restaurant_register` where res_id=$res_id" ;
...
<div class="left_cat_big" id="sticky">
  <div >
<?php

{
echo '<div>';
echo '<div class="cat_subb"  >';//id="sticky">
echo '<div class="cat_head">';
echo '<span style="float:left;color:black;"><i class="fa fa-caret-down fa-2x"></i></span>';
echo "Category";
echo '</div>';
...
$prev_typ = "";
  ...
  ?>
     ...
     <?php echo $product_array[$key]["itm_typ"]; ?></a>
      ...
      <input type="button" id="add_<?php echo $product_array[$key]["itm_id"]; ?>" class="btnAddAction cart-action" onClick = "cartAction('add','<?php echo $product_array[$key]["itm_id"]; ?>','')" <?php if($in_session != "0") { ?> <?php } ?> />
